...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen w-full max-w-full min-w-0 flex-col items-center overflow-x-hidden bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
